...
export default function SocialShare({ url, title }: { url: string; title: string }) {
  ...
  return (
    <div className="flex items-center gap-2 my-8 py-4 border-y border-border-custom">
      <span className="text-sm font-bold uppercase tracking-widest text-muted mr-4">Share</span>
      
      <a 
        href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(fullUrl)}&text=${encodeURIComponent(title)}`}
        target="_blank"
        rel="noopener noreferrer"
        className="p-2 bg-surface border border-border-custom rounded hover:text-[#1DA1F2] hover:border-[#1DA1F2] transition-colors"
      ...
      <a 
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="p-2 bg-surface border border-border-custom rounded hover:text-[#1877F2] hover:border-[#1877F2] transition-colors"
      ...
      <a 
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="p-2 bg-surface border border-border-custom rounded hover:text-[#0A66C2] hover:border-[#0A66C2] transition-colors"
