...
export default async function ArticlePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-background text-text-light pb-20">
      ...
      <main className="container mx-auto px-4 md:px-6 -mt-28 relative z-10 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <article className="lg:col-span-8 bg-surface border border-border-custom rounded-3xl p-6 sm:p-10 lg:p-12 shadow-2xl">
